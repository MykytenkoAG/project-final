...
from ACTIVITY;
DROP
SEQUENCE IF EXISTS ACTIVITY_ID_SEQ cascade;
DROP
SEQUENCE IF EXISTS TASK_ID_SEQ cascade;
DROP
SEQUENCE IF EXISTS SPRINT_ID_SEQ cascade;
DROP
SEQUENCE IF EXISTS PROJECT_ID_SEQ cascade;
DROP
SEQUENCE IF EXISTS USERS_ID_SEQ cascade;
create
